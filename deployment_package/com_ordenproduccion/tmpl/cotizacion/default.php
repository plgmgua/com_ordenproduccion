...
<div class="cotizacion-container">
    ...
    <form id="quotationForm" onsubmit="submitQuotationForm(event)">
        ...
        <!-- Hidden field for client_id if provided via URL -->
        <?php if (!empty($this->clientId)): ?>
            <input type="hidden" name="client_id" value="<?php echo (int) $this->clientId; ?>">
        <?php endif; ?>
        ...
        <div class="items-table-section">
            ...
            <table class="items-table" id="quotationItemsTable">
                <thead>
                    <tr>
                        <th style="width: 10%; min-width: 80px;"><?php echo Text::_('COM_ORDENPRODUCCION_CANTIDAD'); ?></th>
                        <th style="width: 45%; min-width: 200px;"><?php echo Text::_('COM_ORDENPRODUCCION_DESCRIPCION'); ?></th>
                        <th style="width: 20%; min-width: 120px;"><?php echo Text::_('COM_ORDENPRODUCCION_VALOR_UNITARIO'); ?></th>
                        <th style="width: 20%; min-width: 120px;"><?php echo Text::_('COM_ORDENPRODUCCION_SUBTOTAL'); ?></th>
                        <th style="width: 5%; min-width: 60px;"><?php echo Text::_('COM_ORDENPRODUCCION_ACTION'); ?></th>
                    </tr>
                </thead>
