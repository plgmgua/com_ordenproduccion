...
- **File (repository path):** `deployment_package/mod_ordop_pending_approvals-1.2.1-site.zip`  
...
zip -r ../deployment_package/mod_ordop_pending_approvals-1.2.1-site.zip . -x "*.DS_Store"
```
