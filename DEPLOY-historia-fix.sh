...
echo "2. Check 'Historia de Eventos' section on orden page"
echo "3. Should see event record: 'Impresion de Envio'"
echo "4. For parcial with description, should see 2 records:"
