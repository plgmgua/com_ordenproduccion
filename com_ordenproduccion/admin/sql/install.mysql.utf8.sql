...
CREATE TABLE IF NOT EXISTS `#__ordenproduccion_orden_compra` (
    ...
    `approve_email_cc_vendor` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1 = CC vendor on approved-PO email to requester',
    PRIMARY KEY (`id`),
...
-- User session audit log (3.119.111): device / IP / browser for Control de Ventas → User Audit
...
-- Retenciones / Constancia de Exención de IVA (3.119.257)
