...
DELETE FROM `joomla_menu` WHERE `component_id` = (SELECT `extension_id` FROM `joomla_extensions` WHERE `element` = 'com_ordenproduccion' AND `type` = 'component');

-- Get the component ID
SET @component_id = (SELECT `extension_id` FROM `joomla_extensions` WHERE `element` = 'com_ordenproduccion' AND `type` = 'component');
...
UPDATE `joomla_menu` SET `lft` = 1, `rgt` = 14 WHERE `id` = @main_menu_id;
UPDATE `joomla_menu` SET `lft` = 2, `rgt` = 3 WHERE `parent_id` = @main_menu_id AND `alias` = 'com-ordenproduccion-dashboard';
UPDATE `joomla_menu` SET `lft` = 4, `rgt` = 5 WHERE `parent_id` = @main_menu_id AND `alias` = 'com-ordenproduccion-orders';
UPDATE `joomla_menu` SET `lft` = 6, `rgt` = 7 WHERE `parent_id` = @main_menu_id AND `alias` = 'com-ordenproduccion-technicians';
UPDATE `joomla_menu` SET `lft` = 8, `rgt` = 9 WHERE `parent_id` = @main_menu_id AND `alias` = 'com-ordenproduccion-webhook';
UPDATE `joomla_menu` SET `lft` = 10, `rgt` = 11 WHERE `parent_id` = @main_menu_id AND `alias` = 'com-ordenproduccion-debug';
UPDATE `joomla_menu` SET `lft` = 12, `rgt` = 13 WHERE `parent_id` = @main_menu_id AND `alias` = 'com-ordenproduccion-settings';
