...
{
    /**
     * Process pending outbound Telegram messages. Call every ~2 minutes via server cron:
     * wget -q -O - "https://SITE/index.php?option=com_ordenproduccion&controller=telegram&task=processQueue&format=raw&cron_key=SECRET"
     *
     * @return  void
     */
