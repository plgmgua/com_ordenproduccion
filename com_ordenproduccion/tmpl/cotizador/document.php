    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="pliego-line-form" method="post" action="<?php echo $addLineTask; ?>">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="pliego_modal_add_line_btn" disabled><?php echo Text::_('COM_ORDENPRODUCCION_PRE_COTIZACION_ADD_LINE_BTN'); ?></button>
            </div>
        </div>
    </div>
</div>
...
(function() {
    ...
    var addLineBtn = document.getElementById('pliego_modal_add_line_btn');
