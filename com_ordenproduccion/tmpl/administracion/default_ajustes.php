...
<div class="ajustes-subtabs">
    ...
    <a href="<?php echo Route::_('index.php?option=com_ordenproduccion&view=administracion&tab=ajustes&subtab=certificador_fact'); ?>"
       class="ajustes-subtab <?php echo $activeSubTab === 'certificador_fact' ? 'subtab-active' : ''; ?>">
        <i class="fas fa-file-signature"></i>
        <?php echo Text::_('COM_ORDENPRODUCCION_AJUSTES_SUBTAB_CERTIFICADOR_FACT'); ?>
    </a>
    <a href="<?php echo Route::_('index.php?option=com_ordenproduccion&view=administracion&tab=ajustes&subtab=certificador_fact_logs'); ?>"
       class="ajustes-subtab <?php echo $activeSubTab === 'certificador_fact_logs' ? 'subtab-active' : ''; ?>">
    ...
    <a href="<?php echo Route::_('index.php?option=com_ordenproduccion&view=administracion&tab=ajustes&subtab=mt940'); ?>"
       class="ajustes-subtab <?php echo \in_array($activeSubTab, ['mt940', 'mt940_importar', 'mt940_registro'], true) ? 'subtab-active' : ''; ?>">
...
<div class="subtab-content">
    ...
    <?php elseif (\in_array($activeSubTab, ['mt940', 'mt940_importar', 'mt940_registro'], true)): ?>
        ...
        <?php elseif ($activeSubTab === 'mt940_registro'): ?>
            <?php include __DIR__ . '/default_ajustes_mt940_registro.php'; ?>
        <?php else: ?>
