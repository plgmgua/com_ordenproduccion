<?php
/**
 * Asistencia Ausencias tab - justified absences only
    ...
    <div class="col-lg-8 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="get" action="<?php echo Route::_('index.php?option=com_ordenproduccion&view=asistencia&tab=ausencias'); ?>" class="row g-2 mb-3 align-items-end">
                    <input type="hidden" name="option" value="com_ordenproduccion" />
                    <input type="hidden" name="view" value="asistencia" />
                    <input type="hidden" name="tab" value="ausencias" />
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <label class="form-label small"><?php echo AsistenciaHelper::safeText('COM_ORDENPRODUCCION_YEAR', 'Year', 'Año'); ?></label>
                    ...
                    <div class="col-auto">
                        <label class="form-label small"><?php echo AsistenciaHelper::safeText('COM_ORDENPRODUCCION_MONTH', 'Month', 'Mes'); ?></label>
